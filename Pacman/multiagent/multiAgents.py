    ...
    def evaluationFunction(self, currentGameState, action):
        ...
        for ghostPosition in ghostPositions:
            if  abs(newPos[0]-ghostPosition[0])+abs(newPos[1]-ghostPosition[1]) <= 1:
                return gameScore-500

        gameScore += (len(currFoodPositions)-len(newFoodPositions))*100
        ...
        for food in newFoodPositions:
            newDist = ((newPos[0]-food[0])**2+(newPos[1]-food[1])**2)**0.5
            if newDist < newMinFoodDist:
                newMinFoodDist = newDist
                    
        return gameScore-newMinFoodDist
